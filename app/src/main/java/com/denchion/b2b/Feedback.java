...
public class Feedback extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.gb_feedback);
		Bundle bundle = getIntent().getExtras();
		id = bundle.getString("oid");
		DBHelper.loaddb(getApplicationContext());
		Utils.setActionBar(this,"Confirm Order");
		radioGroup = (RadioGroup) findViewById(R.id.feedbk);
		rmrks = (EditText) findViewById(R.id.feedrmrks);
		Imgpath = (TextView) findViewById(R.id.imgpath);
		imgView = (ImageView) findViewById(R.id.imgPreview);
	}
	

	public void action(View v) throws JSONException, UnsupportedEncodingException
	{
		String imgsp="";
...
public void decodeFile(String filePath) {
   ...
   // imgView.setImageBitmap(bitmap);
	...
	public void encodeImagetoString(final String imgpath) {
		new AsyncTask<Void, Void, String>() {
			...
			protected void onPreExecute() {
				  dialog2 = new ProgressDialog(Feedback.this);
			...
			protected void onPostExecute(String msg) {
				...
				params.put("user_id",Utils.getDefaults("user_id", getApplicationContext()));
				params.put("order_id",id);
				params.put("feedback",rdbtn1.getText().toString());
				params.put("remarks",rmrks.getText().toString());
	...
	public void makeHTTPCall() {
		...
		client.post(Utils.storeFeed, params, new AsyncHttpResponseHandler() {
			@Override
