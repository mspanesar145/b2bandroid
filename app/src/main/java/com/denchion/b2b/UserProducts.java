...
public class UserProducts extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.gb_user_products);
	 ...
	 public class JavaScriptInterface {
		   ...
		   {
			   dialog = new ProgressDialog(UserProducts.this);
			    dialog.show();
		   ...
		   @JavascriptInterface
		   public void jump() {
			   Intent loginIntent = new Intent(UserProducts.this, Orders.class);
				 loginIntent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
				 loginIntent.putExtra("tb","0");
				 UserProducts.this.startActivity(loginIntent);
		       finish();
